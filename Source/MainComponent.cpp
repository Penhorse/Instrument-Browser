	...
	options_(options)
{
	...
	error_button_.setImages(true, true, true, cog_image, 0.5f, Colour(), Image(), 1.0f, Colour(), Image(), 1.0f, Colour(), 0);
	error_button_.setSize(32, 32);
	error_button_.addMouseListener(this, false);
